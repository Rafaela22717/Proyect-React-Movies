...
function Detalle() {
    ...
    useEffect(() => {
        const endpoint = `https://api.themoviedb.org/3/movie/${movieID}?api_key=e0cd83b465cb791c8444c563ec079dbf`
    ...
    return (
        <>
            ...
            {movie &&// si tengo info en movie renderiza//renderizado condicional
                <>
                    <h2 className="colorDetalle">Title: {movie.title}</h2>
                    <div className='row'>
                        <div className='col-4'>
                        ...
                        <div className='col-8'>
                            <h5 className="colorDetalle">Review:</h5>
                            ...
                            <h5 className="colorDetalle">Genders:</h5>
